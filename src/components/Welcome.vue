            ...
            >
              <div>
                ...
                <div>
                  <DialogTitle
                    as="h1"
                    class="text-center my-3 sm:my-5"
                  >
                    <div class="text-slate-400 uppercase tracking-widest text-2xl">
                      Welcome to
                    </div>
                    <div class="text-sky-500 font-bold text-3xl md:text-4xl">
                      Readable News
                    </div>
                  </DialogTitle>
                      ...
                      <li class="flex-1 flex sm:flex-col gap-6 place-items-center">
                        <div class="h-20 w-18 flex gap-2 place-items-center">
                          <img
                            ...
                            class="w-12 h-12 rounded saturate-0 opacity-50"
                          >
                      ...
                      <li class="flex-1 flex sm:flex-col gap-6 place-items-center">
                        <div class="h-20 w-18 relative">
                          <div class="w-16 h-18 border rounded bg-white dark:bg-slate-900 dark:border-slate-800 shadow p-1 sm:mx-auto">
                            <div
                              class="bg-slate-200 dark:bg-slate-700 rounded-sm h-5 mb-[3px] mx-auto"
                              style="width: 100%;"
                            />
                            <div
                              class="bg-slate-200 dark:bg-slate-700 rounded-sm h-[2px] mb-[2px]"
                              style="width:95%"
                            />
                            <div
                              class="bg-slate-200 dark:bg-slate-700 rounded-sm h-[2px] mb-[2px]"
                            ...
                            <div
                              class="bg-slate-200 dark:bg-slate-700 rounded-sm h-[3.5px] mb-[3px] mt-[6px]"
                              style="width:50%"
                            />
                            <div
                              class="bg-slate-200 dark:bg-slate-700 rounded-sm h-[2px] mb-[2px]"
